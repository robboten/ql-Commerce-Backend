...
namespace graphApi.Migrations
{
    ...
    [Migration("20240427111934_cartItemMerchantVariantFK")]
    partial class cartItemMerchantVariantFK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.CartItem", b =>
                {
                    ...
                    b.HasOne("graphApi.DataAccess.Entity.ProductVariant", "Merchandise")
                        .WithMany()
