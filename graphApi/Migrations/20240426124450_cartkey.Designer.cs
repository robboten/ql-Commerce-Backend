...
namespace graphApi.Migrations
{
    ...
    [Migration("20240426124450_cartkey")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.Cost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SubtotalAmountId")
                        .HasColumnType("int");

                    b.Property<int?>("TotalAmountId")
                        .HasColumnType("int");

                    b.Property<int?>("TotalTaxAmountId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("SubtotalAmountId");

                    b.HasIndex("TotalAmountId");

                    b.HasIndex("TotalTaxAmountId");
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.Merchandise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.Cart", b =>
                {
                    b.HasOne("graphApi.DataAccess.Entity.Cost", "Cost")
                        .WithMany()
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.CartItem", b =>
                {
                    b.HasOne("graphApi.DataAccess.Entity.Cart", null)
                        .WithMany("Lines")
                    ...
                    b.HasOne("graphApi.DataAccess.Entity.Merchandise", "Merchandise")
                        .WithMany()
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.Cost", b =>
                {
                    b.HasOne("graphApi.DataAccess.Entity.Money", "SubtotalAmount")
                        .WithMany()
                        .HasForeignKey("SubtotalAmountId");

                    b.HasOne("graphApi.DataAccess.Entity.Money", "TotalAmount")
                        .WithMany()
                        .HasForeignKey("TotalAmountId");

                    b.HasOne("graphApi.DataAccess.Entity.Money", "TotalTaxAmount")
                        .WithMany()
                        .HasForeignKey("TotalTaxAmountId");

                    b.Navigation("SubtotalAmount");

                    b.Navigation("TotalAmount");

                    b.Navigation("TotalTaxAmount");
                });
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.Merchandise", b =>
                {
                    b.HasOne("graphApi.DataAccess.Entity.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("graphApi.DataAccess.Entity.SelectedOptions", b =>
                {
                    b.HasOne("graphApi.DataAccess.Entity.Merchandise", null)
